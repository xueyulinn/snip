...
public class CacheService {
    ...
    private final Cache<String, String> processCache = Caffeine.newBuilder().maximumSize(10000).expireAfterWrite(DEFAULT_EXPIRE_TIME).build();
    ...
    String getFromCache(String url){
        ...
        if (val == null) logger.debug("redis cache missed with key {}", url);
        return val;
    }
